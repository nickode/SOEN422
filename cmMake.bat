...
:avr_compile
avr-gcc -Os -Wall -DF_CPU=16000000UL -mmcu=atmega328p src\%1.c src\vmstack.c src\hal.c src\hal_Out.c src\bsl_COut.c src\bsl_IOReg.c src\bsl_xtoa.c src\vm.c -o cm.o
